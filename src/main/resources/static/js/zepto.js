...
var Zepto = (function() {
    ...
    function s(aa) {
        return "children" in aa ? o.call(aa.children) : F.map(aa.childNodes,
        function(ab) {
            if (ab.nodeType == 1) {
                return ab
            }
    ...
    d.fragment = function(ae, ac, ad) {
        ...
        var ab, af, aa = i[ac];
        aa.innerHTML = "" + ae;
        af = F.each(o.call(aa.childNodes),
        function() {
            aa.removeChild(this)
        });
        if (Y(ad)) {
    ...
    F.fn = {
        ...
        toggle: function(aa) {
            return this.each(function() {
                var ab = F(this); (aa === m ? ab.css("display") == "none": aa) ? ab.show() : ab.hide()
            })
        },
        prev: function(aa) {
        ...
        toggleClass: function(ab, aa) {
            return this.each(function(ac) {
                ...
                ad.split(/\s+/g).forEach(function(af) { (aa === m ? !ae.hasClass(af) : aa) ? ae.addClass(af) : ae.removeClass(af)
                })
            })
        },
        scrollTop: function() {
    ...
    F.fn.detach = F.fn.remove; ["width", "height"].forEach(function(aa) {
        F.fn[aa] = function(ac) {
            var ae, ab = this[0],
            ad = aa.replace(/./,
            function(af) {
...
window.Zepto = Zepto;
"$" in window || (window.$ = Zepto); (function(b) {
    function a(d) {
        var g = this.os = {},
        i = this.browser = {},
        p = d.match(/WebKit\/([\d.]+)/),
        ...
        if (o) {
            g.ios = g.iphone = true,
            g.version = o[2].replace(/_/g, ".")
        }
        if (q) {
            g.ios = g.ipad = true,
            g.version = q[2].replace(/_/g, ".")
        }
        if (s) {
            g.webos = true,
            g.version = s[2]
    ...
    c.Event = function(y, x) {
        ...
        v = true;
        if (x) {
            for (var w in x) { (w == "bubbles") ? (v = !!x[w]) : (z[w] = x[w])
            }
        }
    ...
    $.ajax = function(options) {
        ...
        if (dataType == "jsonp" || hasPlaceholder) {
            if (!hasPlaceholder) {
                ...
                //2016-04-13,  gnx 该版本 jsonp callback参数写死的
